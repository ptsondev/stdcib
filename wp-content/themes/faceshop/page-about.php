        ...
        <div class="row">
            <div id="main-content" class="col-sm-12 col-xs-12">
                ...
                <div class="block" id="std-introduct">
					<div class="content-row init odd">
					<div class="pre-content">
						<div class="thumb col-sm-4 col-xs-12"><img alt="Hiệu quả quảng cáo trên các kênh mạng xã hội giảm dần" title="Hiệu quả quảng cáo trên các kênh mạng xã hội giảm dần" src= "<?php echo PATH_TO_IMAGE;?>updown.jpg" /></div>
						<div class="des col-sm-8 col-xs-12">
					...
					<div class="content-row init even">
					<div class="pre-content">
						<div class="thumb col-sm-4 col-xs-12"><img alt="Ngày càng ít khách hàng tiếp cận được đến quảng cáo của bạn" title="Ngày càng ít khách hàng tiếp cận được đến quảng cáo của bạn" src= "<?php echo PATH_TO_IMAGE;?>customer-see-your-ads.jpg" /></div>
						<div class="des col-sm-8 col-xs-12">
					...
					<div class="content-row init odd">
					<div class="pre-content">
						<div class="thumb col-sm-4 col-xs-12"><img alt="Quảng cáo của bạn hoàn toàn phục thuộc vào mạng xã hội" title="Quảng cáo của bạn hoàn toàn phục thuộc vào mạng xã hội" src= "<?php echo PATH_TO_IMAGE;?>phu-thuoc-mang-xa-hoi.jpg" /></div>
						<div class="des col-sm-8 col-xs-12">
