...
if( !class_exists( 'MUCD_Duplicate' ) ) {
    ...
    class MUCD_Duplicate {
        ...
        public static function duplicate_site($data) {
            ...
            // Sher                       
            update_blog_option($to_site_id, AIO_IS_RESPONSIVE, $data[AIO_IS_RESPONSIVE]);
            update_blog_option($to_site_id, AIO_IS_CART, $data[AIO_IS_CART]);
            update_blog_option($to_site_id, AIO_IS_CUSTOMIZE, $data[AIO_IS_CUSTOMIZE]);
            update_blog_option($to_site_id, AIO_MENU_EDITABLE, $data[AIO_MENU_EDITABLE]);		
            // End Sher
