<div class="wrap">
    ...
    <form method="post" action="<?php echo network_admin_url('sites.php?page=' . MUCD_SLUG_NETWORK_ACTION . '&action=' . MUCD_SLUG_ACTION_DUPLICATE); ?>">
        ...
        <table class="form-table" id="advanced-options" style="display: none;">
            ...
            <!-- Sher add more variable before clone -->
            <tr>
                <th scope="row">Responsive</th>
                <td>
                    <label><input name="site[is_responsive]" type="checkbox" value="yes" />Yes</label>                    
                </td>
            </tr>
            <tr>
                <th scope="row">Menu edit able</th>
                <td>
                    <label><input name="site[is_menu_editable]" type="checkbox" value="yes" />Yes</label>                    
                </td>
            </tr>
            <!-- END Sher add more variable before clone -->
        </table>
